...
// components/NavInternational.tsx
// Nawigacja dla dzialu international (/international/*).
// Wzorowany wizualnie na components/Nav.tsx (typografia, uklad, wysokosc).
// Roznice: logo linkuje do /international, menu po angielsku,
// dyskretny przelacznik "PL" w rogu to realny link powrotu do /.

import { useState } from 'react'

const menuItems = [
  { label: 'About', href: '/international/about', key: 'about' },
  { label: 'Artists', href: '/international/artysci', key: 'artysci' },
  { label: 'Works', href: '/international/prace', key: 'prace' },
  { label: 'Exhibitions', href: '/international/wystawy', key: 'wystawy' },
  { label: 'Fairs', href: '/international/targi', key: 'targi' },
  { label: 'Notes', href: '/international/notatki', key: 'notatki' },
]

export default function NavInternational({ active }: { active?: string }) {
  ...
  return (
    <nav className="esta-nav" style={{
      ...
      <a href="/international" className="esta-nav-logo" style={{
