    ...
    <main style={{ background: '#fff', color: '#111' }}>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .nav-link{font-family:var(--font-instrument),sans-serif;font-size:11px;letter-spacing:.12em;text-transform:uppercase;opacity:.5;transition:opacity .2s;}
        .nav-link:hover{opacity:1;}
        .card-img{transition:transform .8s cubic-bezier(.25,.46,.45,.94);}
        .card-hover:hover .card-img{transform:scale(1.03);}
        .artist-link{font-family:var(--font-cormorant),Georgia,serif;display:block;font-size:17px;font-weight:400;line-height:2.4;border-bottom:1px solid #ebebeb;}
        .artist-link:hover{opacity:.4;}
        .arrow-link{display:inline-flex;align-items:center;gap:8px;font-family:var(--font-instrument),sans-serif;font-size:11px;letter-spacing:.12em;text-transform:uppercase;opacity:.6;transition:opacity .2s;}
      ...
      <section style={{ display: 'grid', gridTemplateColumns: '2fr 3fr', minHeight: '80vh', borderTop: '1px solid #ebebeb' }}>
        <div style={{ padding: '72px 48px', display: 'flex', flexDirection: 'column', justifyContent: 'center', borderRight: '1px solid #ebebeb' }}>
          <p style={{ fontFamily: I, fontSize: '10px', fontWeight: 600, letterSpacing: '.2em', textTransform: 'uppercase', marginBottom: '36px' }}>
            Aktualna wystawa
          </p>
          ...
          {aktualna?.opis_krotki && (
            <p style={{ fontFamily: I, fontSize: '13px', color: '#555', lineHeight: 1.8, marginBottom: '40px' }}>
              {aktualna.opis_krotki}
            </p>
          )}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '40px' }}>
          {(targi || []).map((t, i) => (
            <a key={i} href={`/targ/${t.url_targu}`} className="card-hover" style={{ display: 'block' }}>
              ...
              <p style={{ fontFamily: C, fontSize: '18px', fontWeight: 400, marginBottom: '4px' }}>{t.nazwa}</p>
              {t.artysci_txt && <p style={{ fontFamily: I, fontSize: '12px', color: '#888' }}>{t.artysci_txt}</p>}
            </a>
          ))}
        </div>
      </section>
      ...
      <footer style={{ background: '#111', padding: '64px 40px', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '48px' }}>
        <div>
          ...
          <p style={{ fontFamily: I, fontSize: '12px', lineHeight: 2, color: '#555' }}>
            ul. Raciborska 8, Gliwice<br />Od 1998 roku<br />galeria@galeria-esta.pl
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p style={{ fontFamily: I, fontSize: '12px', lineHeight: 2, color: '#555' }}>
            Wt — Pt: 11:00 — 18:00<br />Sob: 11:00 — 15:00<br />Nd — Pn: zamkniete
          </p>
        </div>
        <div>
